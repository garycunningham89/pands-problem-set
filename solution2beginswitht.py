...
import datetime
#Found function from class notes and through Python.org - x = datetime.datetime.now()
...
# Being able to alter the variable to allow the name be forwarded to final print function.
if x.startswith("T"):
    print("Yes, today does begin with a T.")
# Using if function to see if datetime corresponds with the startswith *found on w3schools.
if not x.startswith("T"):
    print ("No, today does not begin with a T.")
# Finishing with if not function to those that do not begin with a T.